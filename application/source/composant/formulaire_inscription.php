   ...
   <div class="d-flex justify-content-center">
    ...
    <h2 id="titre"class="text-center">Getflix</h2>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control <?php echo (isset($email_err)) ? 'is-invalid' : ''; ?>" name="Email" id="email"></input>
                        <span class="invalid-feedback"><?php echo $email_err; ?></span>
                        <span class="valid-feedback" id="valid-mail"></span>
                    </div>
                    <div class="form-group">
                        <label for="password" class="col-form-label">Password:</label>
                        <input type="password" class="form-control <?php echo (isset($password_err)) ? 'is-invalid' : ''; ?>" name="Password" id="password"></input>
                        <span class="invalid-feedback"><?php echo $password_err; ?></span>
                        <span class="valid-feedback" id="valid-user"></span>
                    </div>
                    <div class="form-group">
                        <label for="confirm_password" class="col-form-label">Confirm Password:</label>
                        <input type="password" class="form-control <?php echo (isset($confirm_password_err)) ? 'is-invalid' : ''; ?>" name="confirm_Password" id="confirm_password"></input>
